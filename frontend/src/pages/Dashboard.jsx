...
function Dashboard() {
  ...
  const sortedItems = [...items]
    ...
    .sort((a, b) => {
      if (sortBy === "name") {
        ...
        const qtyCompare = (a.quantity || 0) - (b.quantity || 0);
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      showToast(
        `${deleteModal.item.name} (${deleteModal.item.variety}) deleted`,
        "success"
      );
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
        <Link to="/truck-in" className="block">
          <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl p-4 text-white shadow-lg shadow-emerald-500/20 active:scale-[0.98] transition-transform h-full">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center flex-shrink-0">
                <TruckIcon className="w-5 h-5" />
              </div>
              <div className="min-w-0">
                <p className="font-bold text-sm whitespace-nowrap">Truck IN</p>
        ...
        <Link to="/truck-out" className="block">
          <div className="bg-gradient-to-br from-amber-500 to-orange-500 rounded-2xl p-4 text-white shadow-lg shadow-amber-500/20 active:scale-[0.98] transition-transform h-full">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center flex-shrink-0">
                <TruckIcon className="w-5 h-5" />
              </div>
              <div className="min-w-0">
                <p className="font-bold text-sm whitespace-nowrap">Truck OUT</p>
                <p className="text-amber-100 text-xs whitespace-nowrap">
                  Remove Stock
                </p>
              </div>
            </div>
        ...
        <Link to="/crates" className="block col-span-2 lg:col-span-1">
          <div className="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl p-4 text-white shadow-lg shadow-blue-500/20 active:scale-[0.98] transition-transform h-full">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center flex-shrink-0">
              ...
              <div className="min-w-0">
                ...
                <p className="text-blue-100 text-xs whitespace-nowrap">
                  Track Customer Crates
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            ...
            <div className="divide-y divide-slate-100">
              {sortedItems.map((item) => (
                <div
                  key={item.id}
                  className="grid grid-cols-[1fr,60px,40px] items-center px-4 py-3"
                >
                  <div>
